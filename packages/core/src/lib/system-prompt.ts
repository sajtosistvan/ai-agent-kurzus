...
// B3 — adatbázissal: az agent a runSql toollal kérdezi a products katalógust. A séma + szabályok
// forrása a docs/system-prompt.md. A modell SQL-t ír, futtatja a toollal, majd magyar válasz.
export function buildSystemPromptWithDb(): string {
  return [
    '<role>',
